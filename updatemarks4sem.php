...
if(isset($_POST['usn'])){
    ...
    $db="myproj";
        ...
        if(!$con){
            ...
            $sql="update `marksforthsem` SET `outoff`='$outoff', `18CS42`='$s1', `18CS43`='$s2',`18CS45`= '$s3',`18CS46`='$s4', `18CSL47`='$s5',`18CSL48`= '$s6',`18MAT41`= '$s7', `18MATDIP41`='$s8' where `marksforthsem`.`USN`='$usn';";
...
<body>
    ...
    <div class='container'>
        <h1>WELCOME</h1>
        <p>update forth sem student details</p>
        <?php
            if($submission ==true){
       ...
       <?php
       if($_COOKIE['count']==1){
            echo "<form action='updatemarks4sem.php' method='POST' >
                ...
                <input type='number' name='s18CS32' id='s18CS32' placeholder='18CS42'>
                <input type='number' name='s18CS33' id='s18CS33' placeholder='18CS43'>
                <input type='number' name='s18CS34' id='s18CS34' placeholder='18CS45'>
                <input type='number' name='s18CS35' id='s18CS35' placeholder='18CS46'>
                <input type='number' name='s18CS36' id='s18CS36' placeholder='18CSL47'>
                <input type='number' name='s18CSL37' id='s18CSL37' placeholder='18CSL48'>
                <input type='number' name='s18MAT31' id='s18MAT31' placeholder='18MAT41'>
                <input type='number' name='s18CPC39' id='s18CPC39' placeholder='18MATDIP41'>
