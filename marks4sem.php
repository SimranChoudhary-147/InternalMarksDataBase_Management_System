...
if(isset($_POST['usn'])){
    ...
    $db="myproj";
        ...
        if(!$con){
            ...
            $sql="INSERT INTO `marksforthsem` VALUES ('$usn', '$outoff', '$s1', '$s2', '$s3', '$s4', '$s5', '$s6', '$s7', '$s8');";
...
<body>
       ...
       <div class='topnav'>
                ...
                <a href='index1.php#fotter'>About</a>
    ...
    if($_COOKIE['count']==1){
       echo " <form action='marks4sem.php' method='POST' >
        ...
        cho "<p style='text-align: center;color:red; font-size: 70px;'>login to continue</p>";
    }
    ?>
