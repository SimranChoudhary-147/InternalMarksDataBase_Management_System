...
if(isset($_POST['usn'])){
    ...
    $db="myproj";
        ...
        if(!$con){
            ...
            $sql="update `marksfifthsem` set `outoff`='$outoff', `18CS51`='$s1', `18CS52`='$s2',`18CS53`='$s3', `18CS54`='$s4',`18CS55`= '$s5', `18CS56`='$s6',`18CSL57`='$s7', `18CSL58`='$s8',`18CIV59`='$s9' where `usn`='$usn';";
...
<body>
    ...
    <div class='container'>
       ...
       <?php
       if($_COOKIE['count']==1){
       echo "<form action='updatemarks5sem.php' method='POST' >
